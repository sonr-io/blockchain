...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @summary Queries a list of WhichIs items.
  ...
  queryWhichIsAll = (
    ...
    this.request<BucketQueryAllWhichIsResponse, GooglerpcStatus>({
  ...
  queryWhichIs = (index: string, params: RequestParams = {}) =>
    this.request<BucketQueryGetWhichIsResponse, GooglerpcStatus>({
