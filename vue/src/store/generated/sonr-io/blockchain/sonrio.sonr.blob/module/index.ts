...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgCreateThereIs: (data: MsgCreateThereIs): EncodeObject => ({ typeUrl: "/sonrio.sonr.blob.MsgCreateThereIs", value: MsgCreateThereIs.fromPartial( data ) }),
    msgUpdateThereIs: (data: MsgUpdateThereIs): EncodeObject => ({ typeUrl: "/sonrio.sonr.blob.MsgUpdateThereIs", value: MsgUpdateThereIs.fromPartial( data ) }),
    ...
    msgDeleteThereIs: (data: MsgDeleteThereIs): EncodeObject => ({ typeUrl: "/sonrio.sonr.blob.MsgDeleteThereIs", value: MsgDeleteThereIs.fromPartial( data ) }),
