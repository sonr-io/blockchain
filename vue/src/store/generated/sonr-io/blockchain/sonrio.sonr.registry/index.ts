  ...
  actions: {
    ...
    async QueryWhoIs(
      ...
      try {
        ...
        throw new Error(
          "QueryClient:QueryWhoIs API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },
    ...
    async QueryWhoIsAll(
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryWhoIsAll({
              ...query,
        ...
        if (subscribe)
          commit("SUBSCRIBE", {
            action: "QueryWhoIsAll",
            payload: { options: { all }, params: { ...key }, query },
          });
        return getters["getWhoIsAll"]({ params: { ...key }, query }) ?? {};
      } catch (e) {
        throw new Error(
          "QueryClient:QueryWhoIsAll API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },
    ...
    async sendMsgRegisterName({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgRegisterName:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgRegisterName:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgAccessName({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgAccessName:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgAccessName:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgUpdateName({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateName:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateName:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgAccessApplication(
      { rootGetters },
      { value, fee = [], memo = "" }
    ) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgAccessApplication:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgAccessApplication:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgCreateWhoIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgCreateWhoIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgCreateWhoIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgRegisterApplication(
      { rootGetters },
      { value, fee = [], memo = "" }
    ) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgRegisterApplication:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgRegisterApplication:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgUpdateWhoIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateWhoIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateWhoIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgUpdateApplication(
      { rootGetters },
      { value, fee = [], memo = "" }
    ) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateApplication:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateApplication:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgDeleteWhoIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgDeleteWhoIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgDeleteWhoIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    ...
    async MsgRegisterName({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgRegisterName:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgAccessName({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgAccessName:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateName({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateName:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgAccessApplication({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgAccessApplication:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgCreateWhoIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgCreateWhoIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgRegisterApplication({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgRegisterApplication:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateWhoIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateWhoIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateApplication({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateApplication:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgDeleteWhoIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgDeleteWhoIs:Create Could not create message: " +
              e.message
          );
        }
      }
