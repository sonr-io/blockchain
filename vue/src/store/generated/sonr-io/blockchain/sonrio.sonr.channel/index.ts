...
export { Channel, ChannelMessage, Config, HowIs, Params };
  ...
  actions: {
    ...
    async QueryHowIs(
      ...
      try {
        const key = params ?? {};
        const queryClient = await initQueryClient(rootGetters);
        let value = (await queryClient.queryHowIs(key.index)).data;
        ...
        throw new Error(
          "QueryClient:QueryHowIs API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },
    ...
    async QueryHowIsAll(
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryHowIsAll({
              ...query,
        ...
        if (subscribe)
          commit("SUBSCRIBE", {
            action: "QueryHowIsAll",
            payload: { options: { all }, params: { ...key }, query },
          });
        return getters["getHowIsAll"]({ params: { ...key }, query }) ?? {};
      } catch (e) {
        throw new Error(
          "QueryClient:QueryHowIsAll API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },
    ...
    async sendMsgReadChannel({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgReadChannel:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgReadChannel:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgUpdateChannel(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateChannel:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateChannel:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgCreateHowIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgCreateHowIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgCreateHowIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgDeleteHowIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgDeleteHowIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgDeleteHowIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgCreateChannel(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgCreateChannel:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgCreateChannel:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgDeleteChannel(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgDeleteChannel:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgDeleteChannel:Send Could not broadcast Tx: " +
              e.message
          );
        }
      }
    ...
    async sendMsgUpdateHowIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateHowIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateHowIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    ...
    async MsgReadChannel({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgReadChannel:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateChannel({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateChannel:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgCreateHowIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgCreateHowIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgDeleteHowIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgDeleteHowIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgCreateChannel({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgCreateChannel:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgDeleteChannel({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgDeleteChannel:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateHowIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateHowIs:Create Could not create message: " +
              e.message
          );
        }
      }
