  ...
  actions: {
    ...
    async QueryWhatIs(
      ...
      try {
        ...
        throw new Error(
          "QueryClient:QueryWhatIs API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },

    async QueryWhatIsAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryWhatIsAll({
              ...query,
        ...
        if (subscribe)
          commit("SUBSCRIBE", {
            action: "QueryWhatIsAll",
            payload: { options: { all }, params: { ...key }, query },
          });
        return getters["getWhatIsAll"]({ params: { ...key }, query }) ?? {};
      } catch (e) {
        throw new Error(
          "QueryClient:QueryWhatIsAll API Node Unavailable. Could not perform query: " +
            e.message
        );
      }
    },
    ...
    async sendMsgUpdateWhatIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateWhatIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateWhatIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgCreateObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgCreateObject:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgCreateObject:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgReadObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgReadObject:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgReadObject:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgDeleteObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgDeleteObject:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgDeleteObject:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgDeleteWhatIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgDeleteWhatIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgDeleteWhatIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgUpdateObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgUpdateObject:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgUpdateObject:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    async sendMsgCreateWhatIs({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            "TxClient:MsgCreateWhatIs:Init Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new Error(
            "TxClient:MsgCreateWhatIs:Send Could not broadcast Tx: " + e.message
          );
        }
      }
    },
    ...
    async MsgUpdateWhatIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateWhatIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgCreateObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgCreateObject:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgReadObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgReadObject:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgDeleteObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgDeleteObject:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgDeleteWhatIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgDeleteWhatIs:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgUpdateObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgUpdateObject:Create Could not create message: " +
              e.message
          );
        }
      }
    ...
    async MsgCreateWhatIs({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            "TxClient:MsgCreateWhatIs:Create Could not create message: " +
              e.message
          );
        }
      }
