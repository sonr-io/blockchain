...
func (m *WhichIs) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
var fileDescriptor_b12711a1b047ec75 = []byte{
	...
	,
}
...
func (m *WhichIs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintWhichIs(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Did) > 0 {
