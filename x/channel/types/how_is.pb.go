...
var fileDescriptor_76fab69227613021 = []byte{
	...
	0x17, 0x12, 0x2e, 0xce, 0xcf, 0x2b, 0xca, 0xcc, 0xd7, 0x03, 0x51, 0x7a, 0x50, 0x15, 0x4a, 0xf1,
	...
	0xe2, 0x30, 0xae, 0x93, 0xe3, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24,
	0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0xa9,
	0xa7, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x83, 0xdc, 0xa4, 0x9b, 0x99,
	0x0f, 0xa6, 0xf5, 0x2b, 0xf4, 0x61, 0xee, 0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xbb,
	0xdf, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xc1, 0xe0, 0xda, 0xee, 0xd7, 0x00, 0x00, 0x00,
}
...
func (m *HowIs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintHowIs(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Did) > 0 {
