...
func (*Records) Descriptor() ([]byte, []int) {
	return fileDescriptor_a5343ace9f6c59a5, []int{0}
}
...
func (m *Records) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *Records) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (m *Records) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Records)(nil), "sonrio.sonr.exchange.Records")
}

func init() { proto.RegisterFile("exchange/records.proto", fileDescriptor_a5343ace9f6c59a5) }

var fileDescriptor_a5343ace9f6c59a5 = []byte{
	// 191 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4b, 0xad, 0x48, 0xce,
	0x48, 0xcc, 0x4b, 0x4f, 0xd5, 0x2f, 0x4a, 0x4d, 0xce, 0x2f, 0x4a, 0x29, 0xd6, 0x2b, 0x28, 0xca,
	0x2f, 0xc9, 0x17, 0x12, 0x29, 0xce, 0xcf, 0x2b, 0xca, 0xcc, 0xd7, 0x03, 0x51, 0x7a, 0x30, 0x35,
	0x4a, 0x89, 0x5c, 0xec, 0x41, 0x10, 0x65, 0x42, 0x22, 0x5c, 0xac, 0x99, 0x79, 0x29, 0xa9, 0x15,
	...
	0x0f, 0xa6, 0xf5, 0x2b, 0xf4, 0xe1, 0x9e, 0x28, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xfb,
	0xc1, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x64, 0x9c, 0x87, 0x37, 0xdd, 0x00, 0x00, 0x00,
}
...
func (m *Records) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintRecords(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintRecords(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Did) > 0 {
		i -= len(m.Did)
		copy(dAtA[i:], m.Did)
		i = encodeVarintRecords(dAtA, i, uint64(len(m.Did)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintRecords(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
