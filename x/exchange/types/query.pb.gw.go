...
func request_Query_Records_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryGetRecordsRequest
	var metadata runtime.ServerMetadata
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sonrio", "sonr", "exchange", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Records_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sonr-io", "sonr", "exchange", "records", "index"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RecordsAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sonr-io", "sonr", "exchange", "records"}, "", runtime.AssumeColonVerbOpt(true)))
)
