...
type MsgCreateObject struct {
	...
	InitialFields map[string]*ObjectValue `protobuf:"bytes,4,rep,name=initial_fields,json=initialFields,proto3" json:"initial_fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MsgCreateObject) GetInitialFields() map[string]*ObjectValue {
	if m != nil {
...
type MsgQueryObject struct {
	Did string `protobuf:"bytes,1,opt,name=did,proto3" json:"did,omitempty"`
}

func (m *MsgQueryObject) Reset()         { *m = MsgQueryObject{} }
func (m *MsgQueryObject) String() string { return proto.CompactTextString(m) }
func (*MsgQueryObject) ProtoMessage()    {}
func (*MsgQueryObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_d88dea960c76a188, []int{2}
}
func (m *MsgQueryObject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgQueryObject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgQueryObject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgQueryObject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgQueryObject.Merge(m, src)
}
func (m *MsgQueryObject) XXX_Size() int {
	return m.Size()
}
func (m *MsgQueryObject) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgQueryObject.DiscardUnknown(m)
}

var xxx_messageInfo_MsgQueryObject proto.InternalMessageInfo

func (m *MsgQueryObject) GetDid() string {
	if m != nil {
		return m.Did
	}
	return ""
...
type MsgQueryObjectResponse struct {
	Code    int32   `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Message string  `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	WhatIs  *WhatIs `protobuf:"bytes,3,opt,name=what_is,json=whatIs,proto3" json:"what_is,omitempty"`
}

func (m *MsgQueryObjectResponse) Reset()         { *m = MsgQueryObjectResponse{} }
func (m *MsgQueryObjectResponse) String() string { return proto.CompactTextString(m) }
func (*MsgQueryObjectResponse) ProtoMessage()    {}
func (*MsgQueryObjectResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d88dea960c76a188, []int{3}
}
func (m *MsgQueryObjectResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgQueryObjectResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgQueryObjectResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgQueryObjectResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgQueryObjectResponse.Merge(m, src)
}
func (m *MsgQueryObjectResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgQueryObjectResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgQueryObjectResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgQueryObjectResponse proto.InternalMessageInfo

func (m *MsgQueryObjectResponse) GetCode() int32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *MsgQueryObjectResponse) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (m *MsgQueryObjectResponse) GetWhatIs() *WhatIs {
	if m != nil {
		return m.WhatIs
	}
	return nil
...
type MsgUpdateObject struct {
	...
	AddedFields map[string]*ObjectValue `protobuf:"bytes,4,rep,name=added_fields,json=addedFields,proto3" json:"added_fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Removed fields from the object, where keys are the TypeField names
	RemovedFields map[string]*ObjectValue `protobuf:"bytes,5,rep,name=removed_fields,json=removedFields,proto3" json:"removed_fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MsgUpdateObject) GetAddedFields() map[string]*ObjectValue {
	if m != nil {
...
func (m *MsgUpdateObject) GetRemovedFields() map[string]*ObjectValue {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*ObjectValue)(nil), "sonrio.sonr.object.MsgCreateObject.InitialFieldsEntry")
	proto.RegisterType((*MsgCreateObjectResponse)(nil), "sonrio.sonr.object.MsgCreateObjectResponse")
	proto.RegisterType((*MsgQueryObject)(nil), "sonrio.sonr.object.MsgQueryObject")
	proto.RegisterType((*MsgQueryObjectResponse)(nil), "sonrio.sonr.object.MsgQueryObjectResponse")
	proto.RegisterType((*MsgUpdateObject)(nil), "sonrio.sonr.object.MsgUpdateObject")
	proto.RegisterMapType((map[string]*ObjectValue)(nil), "sonrio.sonr.object.MsgUpdateObject.AddedFieldsEntry")
	proto.RegisterMapType((map[string]*ObjectValue)(nil), "sonrio.sonr.object.MsgUpdateObject.RemovedFieldsEntry")
...
var fileDescriptor_d88dea960c76a188 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	QueryObject(ctx context.Context, in *MsgQueryObject, opts ...grpc.CallOption) (*MsgQueryObjectResponse, error)
	// UpdateObject
	//
...
func (c *msgClient) QueryObject(ctx context.Context, in *MsgQueryObject, opts ...grpc.CallOption) (*MsgQueryObjectResponse, error) {
	out := new(MsgQueryObjectResponse)
	err := c.cc.Invoke(ctx, "/sonrio.sonr.object.Msg/QueryObject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	//
	// QueryObject is the transaction that queries an object
	QueryObject(context.Context, *MsgQueryObject) (*MsgQueryObjectResponse, error)
	// UpdateObject
	//
	// UpdateObject is the transaction that updates an existing object.
...
func (*UnimplementedMsgServer) QueryObject(ctx context.Context, req *MsgQueryObject) (*MsgQueryObjectResponse, error) {
...
func _Msg_QueryObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgQueryObject)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).QueryObject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonrio.sonr.object.Msg/QueryObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).QueryObject(ctx, req.(*MsgQueryObject))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Msg_QueryObject_Handler,
		},
		{
...
func (m *MsgQueryObject) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgQueryObject) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgQueryObject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgQueryObjectResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgQueryObjectResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgQueryObjectResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgQueryObject) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgQueryObjectResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgCreateObject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.InitialFields == nil {
				m.InitialFields = make(map[string]*ObjectValue)
			}
			var mapkey string
			...
			m.InitialFields[mapkey] = mapvalue
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
...
func (m *MsgQueryObject) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgQueryObject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgQueryObject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgQueryObjectResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgQueryObjectResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgQueryObjectResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.AddedFields == nil {
				m.AddedFields = make(map[string]*ObjectValue)
			}
			var mapkey string
			var mapvalue *ObjectValue
			for iNdEx < postIndex {
		...
		case 5:
			...
			if m.RemovedFields == nil {
				m.RemovedFields = make(map[string]*ObjectValue)
			}
			var mapkey string
			var mapvalue *ObjectValue
			for iNdEx < postIndex {
			...
			m.RemovedFields[mapkey] = mapvalue
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
