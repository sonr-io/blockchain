...
import (
	...
	"github.com/sonr-io/sonr/common/discover"
	"github.com/sonr-io/sonr/common/exchange"
	"github.com/sonr-io/sonr/core/bucket"
	"github.com/sonr-io/sonr/core/channel"
...
type HighwayStub struct {
	...
	*exchange.ExchangeProtocol
	...
	objects  map[string]*object.ObjectDoc
}

// NewHighway creates a new Highway service stub for the node.
func NewHighway(ctx context.Context, n node.NodeImpl, loc *common.Location, lst net.Listener) (*HighwayStub, error) {
	...
	if err = v1.RegisterHighwayServiceHandlerFromEndpoint(ctx, stub.mux, "localhost:8080", opts); err != nil {
