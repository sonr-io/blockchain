...
var file_v1_highway_proto_goTypes = []interface{}{
	...
	(*types.MsgRegisterName)(nil),            // 1: sonrio.sonr.registry.MsgRegisterName
	(*types.MsgUpdateName)(nil),              // 2: sonrio.sonr.registry.MsgUpdateName
	(*AccessServiceRequest)(nil),             // 3: highway.v1.AccessServiceRequest
	(*types.MsgRegisterService)(nil),         // 4: sonrio.sonr.registry.MsgRegisterService
	(*types.MsgUpdateService)(nil),           // 5: sonrio.sonr.registry.MsgUpdateService
	(*types1.MsgCreateChannel)(nil),          // 6: sonrio.sonr.channel.MsgCreateChannel
	(*types1.MsgReadChannel)(nil),            // 7: sonrio.sonr.channel.MsgReadChannel
	(*types1.MsgUpdateChannel)(nil),          // 8: sonrio.sonr.channel.MsgUpdateChannel
	(*types1.MsgDeleteChannel)(nil),          // 9: sonrio.sonr.channel.MsgDeleteChannel
	(*ListenChannelRequest)(nil),             // 10: highway.v1.ListenChannelRequest
	(*types2.MsgCreateBucket)(nil),           // 11: sonrio.sonr.bucket.MsgCreateBucket
	(*types2.MsgReadBucket)(nil),             // 12: sonrio.sonr.bucket.MsgReadBucket
	(*types2.MsgUpdateBucket)(nil),           // 13: sonrio.sonr.bucket.MsgUpdateBucket
	(*types2.MsgDeleteBucket)(nil),           // 14: sonrio.sonr.bucket.MsgDeleteBucket
	(*ListenBucketRequest)(nil),              // 15: highway.v1.ListenBucketRequest
	(*types3.MsgCreateObject)(nil),           // 16: sonrio.sonr.object.MsgCreateObject
	(*types3.MsgReadObject)(nil),             // 17: sonrio.sonr.object.MsgReadObject
	(*types3.MsgUpdateObject)(nil),           // 18: sonrio.sonr.object.MsgUpdateObject
	(*types3.MsgDeleteObject)(nil),           // 19: sonrio.sonr.object.MsgDeleteObject
	...
	(*types.MsgRegisterNameResponse)(nil),    // 27: sonrio.sonr.registry.MsgRegisterNameResponse
	(*types.MsgUpdateNameResponse)(nil),      // 28: sonrio.sonr.registry.MsgUpdateNameResponse
	(*AccessServiceResponse)(nil),            // 29: highway.v1.AccessServiceResponse
	(*types.MsgRegisterServiceResponse)(nil), // 30: sonrio.sonr.registry.MsgRegisterServiceResponse
	(*types.MsgUpdateServiceResponse)(nil),   // 31: sonrio.sonr.registry.MsgUpdateServiceResponse
	(*types1.MsgCreateChannelResponse)(nil),  // 32: sonrio.sonr.channel.MsgCreateChannelResponse
	(*types1.MsgReadChannelResponse)(nil),    // 33: sonrio.sonr.channel.MsgReadChannelResponse
	(*types1.MsgUpdateChannelResponse)(nil),  // 34: sonrio.sonr.channel.MsgUpdateChannelResponse
	(*types1.MsgDeleteChannelResponse)(nil),  // 35: sonrio.sonr.channel.MsgDeleteChannelResponse
	(*types1.ChannelMessage)(nil),            // 36: sonrio.sonr.channel.ChannelMessage
	(*types2.MsgCreateBucketResponse)(nil),   // 37: sonrio.sonr.bucket.MsgCreateBucketResponse
	(*types2.MsgReadBucketResponse)(nil),     // 38: sonrio.sonr.bucket.MsgReadBucketResponse
	(*types2.MsgUpdateBucketResponse)(nil),   // 39: sonrio.sonr.bucket.MsgUpdateBucketResponse
	(*types2.MsgDeleteBucketResponse)(nil),   // 40: sonrio.sonr.bucket.MsgDeleteBucketResponse
	(*ListenBucketResponse)(nil),             // 41: highway.v1.ListenBucketResponse
	(*types3.MsgCreateObjectResponse)(nil),   // 42: sonrio.sonr.object.MsgCreateObjectResponse
	(*types3.MsgReadObjectResponse)(nil),     // 43: sonrio.sonr.object.MsgReadObjectResponse
	(*types3.MsgUpdateObjectResponse)(nil),   // 44: sonrio.sonr.object.MsgUpdateObjectResponse
	(*types3.MsgDeleteObjectResponse)(nil),   // 45: sonrio.sonr.object.MsgDeleteObjectResponse
