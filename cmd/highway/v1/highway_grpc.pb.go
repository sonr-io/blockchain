...
import (
	...
	types1 "github.com/sonr-io/sonr/x/channel/types"
	types3 "github.com/sonr-io/sonr/x/object/types"
...
type HighwayServiceClient interface {
	...
	// once per node.
	RegisterName(ctx context.Context, in *types.MsgRegisterName, opts ...grpc.CallOption) (*types.MsgRegisterNameResponse, error)
	// UpdateName updates the public information of the calling node.
	UpdateName(ctx context.Context, in *types.MsgUpdateName, opts ...grpc.CallOption) (*types.MsgUpdateNameResponse, error)
	...
	RegisterService(ctx context.Context, in *types.MsgRegisterService, opts ...grpc.CallOption) (*types.MsgRegisterServiceResponse, error)
	// UpdateService updates the details and public configuration of the calling node's service.
	UpdateService(ctx context.Context, in *types.MsgUpdateService, opts ...grpc.CallOption) (*types.MsgUpdateServiceResponse, error)
	...
	CreateChannel(ctx context.Context, in *types1.MsgCreateChannel, opts ...grpc.CallOption) (*types1.MsgCreateChannelResponse, error)
	// ReadChannel lists all peers subscribed to the given channel, and additional details about
	// the channels configuration.
	ReadChannel(ctx context.Context, in *types1.MsgReadChannel, opts ...grpc.CallOption) (*types1.MsgReadChannelResponse, error)
	// UpdateChannel updates the configuration of the given channel.
	UpdateChannel(ctx context.Context, in *types1.MsgUpdateChannel, opts ...grpc.CallOption) (*types1.MsgUpdateChannelResponse, error)
	// DeleteChannel deletes the given channel if the calling node is the owner of the channel.
	DeleteChannel(ctx context.Context, in *types1.MsgDeleteChannel, opts ...grpc.CallOption) (*types1.MsgDeleteChannelResponse, error)
	...
	CreateBucket(ctx context.Context, in *types2.MsgCreateBucket, opts ...grpc.CallOption) (*types2.MsgCreateBucketResponse, error)
	// ReadBucket lists all the blobs in the given bucket. The calling node must have access to the
	// bucket.
	ReadBucket(ctx context.Context, in *types2.MsgReadBucket, opts ...grpc.CallOption) (*types2.MsgReadBucketResponse, error)
	// UpdateBucket updates the configuration of the given bucket. The calling node must have access
	// to the bucket.
	UpdateBucket(ctx context.Context, in *types2.MsgUpdateBucket, opts ...grpc.CallOption) (*types2.MsgUpdateBucketResponse, error)
	// DeleteBucket deletes the given bucket if the calling node is the owner of the bucket.
	DeleteBucket(ctx context.Context, in *types2.MsgDeleteBucket, opts ...grpc.CallOption) (*types2.MsgDeleteBucketResponse, error)
	...
	CreateObject(ctx context.Context, in *types3.MsgCreateObject, opts ...grpc.CallOption) (*types3.MsgCreateObjectResponse, error)
	// ReadObject returns the details of the given object provided its DID or Label.
	ReadObject(ctx context.Context, in *types3.MsgReadObject, opts ...grpc.CallOption) (*types3.MsgReadObjectResponse, error)
	// UpdateObject modifies the property fields of the given object.
	UpdateObject(ctx context.Context, in *types3.MsgUpdateObject, opts ...grpc.CallOption) (*types3.MsgUpdateObjectResponse, error)
	// DeleteObject deletes the given object if the calling node is the owner of the object.
	DeleteObject(ctx context.Context, in *types3.MsgDeleteObject, opts ...grpc.CallOption) (*types3.MsgDeleteObjectResponse, error)
...
func (c *highwayServiceClient) RegisterName(ctx context.Context, in *types.MsgRegisterName, opts ...grpc.CallOption) (*types.MsgRegisterNameResponse, error) {
	out := new(types.MsgRegisterNameResponse)
...
func (c *highwayServiceClient) UpdateName(ctx context.Context, in *types.MsgUpdateName, opts ...grpc.CallOption) (*types.MsgUpdateNameResponse, error) {
	out := new(types.MsgUpdateNameResponse)
...
func (c *highwayServiceClient) RegisterService(ctx context.Context, in *types.MsgRegisterService, opts ...grpc.CallOption) (*types.MsgRegisterServiceResponse, error) {
	out := new(types.MsgRegisterServiceResponse)
...
func (c *highwayServiceClient) UpdateService(ctx context.Context, in *types.MsgUpdateService, opts ...grpc.CallOption) (*types.MsgUpdateServiceResponse, error) {
	out := new(types.MsgUpdateServiceResponse)
...
func (c *highwayServiceClient) CreateChannel(ctx context.Context, in *types1.MsgCreateChannel, opts ...grpc.CallOption) (*types1.MsgCreateChannelResponse, error) {
	out := new(types1.MsgCreateChannelResponse)
...
func (c *highwayServiceClient) ReadChannel(ctx context.Context, in *types1.MsgReadChannel, opts ...grpc.CallOption) (*types1.MsgReadChannelResponse, error) {
	out := new(types1.MsgReadChannelResponse)
...
func (c *highwayServiceClient) UpdateChannel(ctx context.Context, in *types1.MsgUpdateChannel, opts ...grpc.CallOption) (*types1.MsgUpdateChannelResponse, error) {
	out := new(types1.MsgUpdateChannelResponse)
...
func (c *highwayServiceClient) DeleteChannel(ctx context.Context, in *types1.MsgDeleteChannel, opts ...grpc.CallOption) (*types1.MsgDeleteChannelResponse, error) {
	out := new(types1.MsgDeleteChannelResponse)
...
type HighwayService_ListenChannelClient interface {
	Recv() (*types1.ChannelMessage, error)
	grpc.ClientStream
}
...
func (x *highwayServiceListenChannelClient) Recv() (*types1.ChannelMessage, error) {
	m := new(types1.ChannelMessage)
...
func (c *highwayServiceClient) CreateBucket(ctx context.Context, in *types2.MsgCreateBucket, opts ...grpc.CallOption) (*types2.MsgCreateBucketResponse, error) {
	out := new(types2.MsgCreateBucketResponse)
...
func (c *highwayServiceClient) ReadBucket(ctx context.Context, in *types2.MsgReadBucket, opts ...grpc.CallOption) (*types2.MsgReadBucketResponse, error) {
	out := new(types2.MsgReadBucketResponse)
...
func (c *highwayServiceClient) UpdateBucket(ctx context.Context, in *types2.MsgUpdateBucket, opts ...grpc.CallOption) (*types2.MsgUpdateBucketResponse, error) {
	out := new(types2.MsgUpdateBucketResponse)
...
func (c *highwayServiceClient) DeleteBucket(ctx context.Context, in *types2.MsgDeleteBucket, opts ...grpc.CallOption) (*types2.MsgDeleteBucketResponse, error) {
	out := new(types2.MsgDeleteBucketResponse)
...
func (c *highwayServiceClient) CreateObject(ctx context.Context, in *types3.MsgCreateObject, opts ...grpc.CallOption) (*types3.MsgCreateObjectResponse, error) {
	out := new(types3.MsgCreateObjectResponse)
...
func (c *highwayServiceClient) ReadObject(ctx context.Context, in *types3.MsgReadObject, opts ...grpc.CallOption) (*types3.MsgReadObjectResponse, error) {
	out := new(types3.MsgReadObjectResponse)
...
func (c *highwayServiceClient) UpdateObject(ctx context.Context, in *types3.MsgUpdateObject, opts ...grpc.CallOption) (*types3.MsgUpdateObjectResponse, error) {
	out := new(types3.MsgUpdateObjectResponse)
...
func (c *highwayServiceClient) DeleteObject(ctx context.Context, in *types3.MsgDeleteObject, opts ...grpc.CallOption) (*types3.MsgDeleteObjectResponse, error) {
	out := new(types3.MsgDeleteObjectResponse)
...
type HighwayServiceServer interface {
	...
	// RegisterName registers a new ".snr" name for the calling node. It is only allowed to be called
	// once per node.
	RegisterName(context.Context, *types.MsgRegisterName) (*types.MsgRegisterNameResponse, error)
	// UpdateName updates the public information of the calling node.
	UpdateName(context.Context, *types.MsgUpdateName) (*types.MsgUpdateNameResponse, error)
	// AccessService creates a new signing key for the calling node in order to be authorized to
	// access the service. It is only allowed to be called once per node.
	AccessService(context.Context, *AccessServiceRequest) (*AccessServiceResponse, error)
	// RegisterService registers a new service for the calling node. The calling node must have
	// already been enabled for development.
	RegisterService(context.Context, *types.MsgRegisterService) (*types.MsgRegisterServiceResponse, error)
	// UpdateService updates the details and public configuration of the calling node's service.
	UpdateService(context.Context, *types.MsgUpdateService) (*types.MsgUpdateServiceResponse, error)
	// CreateChannel creates a new Publish/Subscribe topic channel for the given service.
	// The calling node must have already registered a service for the channel.
	CreateChannel(context.Context, *types1.MsgCreateChannel) (*types1.MsgCreateChannelResponse, error)
	// ReadChannel lists all peers subscribed to the given channel, and additional details about
	// the channels configuration.
	ReadChannel(context.Context, *types1.MsgReadChannel) (*types1.MsgReadChannelResponse, error)
	// UpdateChannel updates the configuration of the given channel.
	UpdateChannel(context.Context, *types1.MsgUpdateChannel) (*types1.MsgUpdateChannelResponse, error)
	// DeleteChannel deletes the given channel if the calling node is the owner of the channel.
	DeleteChannel(context.Context, *types1.MsgDeleteChannel) (*types1.MsgDeleteChannelResponse, error)
	// ListenChannel subscribes the calling node to the given channel and returns all publish events
	// as a stream.
	ListenChannel(*ListenChannelRequest, HighwayService_ListenChannelServer) error
	// CreateBucket creates a new bucket for the calling nodes service.
	CreateBucket(context.Context, *types2.MsgCreateBucket) (*types2.MsgCreateBucketResponse, error)
	// ReadBucket lists all the blobs in the given bucket. The calling node must have access to the
	// bucket.
	ReadBucket(context.Context, *types2.MsgReadBucket) (*types2.MsgReadBucketResponse, error)
	// UpdateBucket updates the configuration of the given bucket. The calling node must have access
	// to the bucket.
	UpdateBucket(context.Context, *types2.MsgUpdateBucket) (*types2.MsgUpdateBucketResponse, error)
	// DeleteBucket deletes the given bucket if the calling node is the owner of the bucket.
	DeleteBucket(context.Context, *types2.MsgDeleteBucket) (*types2.MsgDeleteBucketResponse, error)
	// ListenBucket subscribes the calling node to the given bucket and returns all publish events
	// as a stream.
	ListenBucket(*ListenBucketRequest, HighwayService_ListenBucketServer) error
	// CreateObject defines a new object to be utilized by the calling node's service. The object will
	// be placed in the Highway Service Graph and can be used in channels and other modules.
	CreateObject(context.Context, *types3.MsgCreateObject) (*types3.MsgCreateObjectResponse, error)
	// ReadObject returns the details of the given object provided its DID or Label.
	ReadObject(context.Context, *types3.MsgReadObject) (*types3.MsgReadObjectResponse, error)
	// UpdateObject modifies the property fields of the given object.
	UpdateObject(context.Context, *types3.MsgUpdateObject) (*types3.MsgUpdateObjectResponse, error)
	// DeleteObject deletes the given object if the calling node is the owner of the object.
	DeleteObject(context.Context, *types3.MsgDeleteObject) (*types3.MsgDeleteObjectResponse, error)
	// UploadBlob uploads a file or buffer to the calling node's service IPFS storage.
...
func (UnimplementedHighwayServiceServer) RegisterName(context.Context, *types.MsgRegisterName) (*types.MsgRegisterNameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterName not implemented")
}
func (UnimplementedHighwayServiceServer) UpdateName(context.Context, *types.MsgUpdateName) (*types.MsgUpdateNameResponse, error) {
...
func (UnimplementedHighwayServiceServer) RegisterService(context.Context, *types.MsgRegisterService) (*types.MsgRegisterServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterService not implemented")
}
func (UnimplementedHighwayServiceServer) UpdateService(context.Context, *types.MsgUpdateService) (*types.MsgUpdateServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateService not implemented")
}
func (UnimplementedHighwayServiceServer) CreateChannel(context.Context, *types1.MsgCreateChannel) (*types1.MsgCreateChannelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateChannel not implemented")
}
func (UnimplementedHighwayServiceServer) ReadChannel(context.Context, *types1.MsgReadChannel) (*types1.MsgReadChannelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadChannel not implemented")
}
func (UnimplementedHighwayServiceServer) UpdateChannel(context.Context, *types1.MsgUpdateChannel) (*types1.MsgUpdateChannelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateChannel not implemented")
}
func (UnimplementedHighwayServiceServer) DeleteChannel(context.Context, *types1.MsgDeleteChannel) (*types1.MsgDeleteChannelResponse, error) {
...
func (UnimplementedHighwayServiceServer) CreateBucket(context.Context, *types2.MsgCreateBucket) (*types2.MsgCreateBucketResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBucket not implemented")
}
func (UnimplementedHighwayServiceServer) ReadBucket(context.Context, *types2.MsgReadBucket) (*types2.MsgReadBucketResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadBucket not implemented")
}
func (UnimplementedHighwayServiceServer) UpdateBucket(context.Context, *types2.MsgUpdateBucket) (*types2.MsgUpdateBucketResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBucket not implemented")
}
func (UnimplementedHighwayServiceServer) DeleteBucket(context.Context, *types2.MsgDeleteBucket) (*types2.MsgDeleteBucketResponse, error) {
...
func (UnimplementedHighwayServiceServer) CreateObject(context.Context, *types3.MsgCreateObject) (*types3.MsgCreateObjectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateObject not implemented")
}
func (UnimplementedHighwayServiceServer) ReadObject(context.Context, *types3.MsgReadObject) (*types3.MsgReadObjectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadObject not implemented")
}
func (UnimplementedHighwayServiceServer) UpdateObject(context.Context, *types3.MsgUpdateObject) (*types3.MsgUpdateObjectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateObject not implemented")
}
func (UnimplementedHighwayServiceServer) DeleteObject(context.Context, *types3.MsgDeleteObject) (*types3.MsgDeleteObjectResponse, error) {
...
func _HighwayService_RegisterName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).RegisterName(ctx, req.(*types.MsgRegisterName))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_UpdateName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).UpdateName(ctx, req.(*types.MsgUpdateName))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_RegisterService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types.MsgRegisterService)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).RegisterService(ctx, req.(*types.MsgRegisterService))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_UpdateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).UpdateService(ctx, req.(*types.MsgUpdateService))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_CreateChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types1.MsgCreateChannel)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).CreateChannel(ctx, req.(*types1.MsgCreateChannel))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_ReadChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).ReadChannel(ctx, req.(*types1.MsgReadChannel))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_UpdateChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types1.MsgUpdateChannel)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).UpdateChannel(ctx, req.(*types1.MsgUpdateChannel))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_DeleteChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types1.MsgDeleteChannel)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).DeleteChannel(ctx, req.(*types1.MsgDeleteChannel))
	}
	return interceptor(ctx, in, info, handler)
}
...
type HighwayService_ListenChannelServer interface {
	Send(*types1.ChannelMessage) error
	grpc.ServerStream
}
...
func (x *highwayServiceListenChannelServer) Send(m *types1.ChannelMessage) error {
...
func _HighwayService_CreateBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).CreateBucket(ctx, req.(*types2.MsgCreateBucket))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_ReadBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).ReadBucket(ctx, req.(*types2.MsgReadBucket))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_UpdateBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).UpdateBucket(ctx, req.(*types2.MsgUpdateBucket))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_DeleteBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).DeleteBucket(ctx, req.(*types2.MsgDeleteBucket))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_CreateObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).CreateObject(ctx, req.(*types3.MsgCreateObject))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_ReadObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).ReadObject(ctx, req.(*types3.MsgReadObject))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_UpdateObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).UpdateObject(ctx, req.(*types3.MsgUpdateObject))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HighwayService_DeleteObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HighwayServiceServer).DeleteObject(ctx, req.(*types3.MsgDeleteObject))
	}
	return interceptor(ctx, in, info, handler)
}
