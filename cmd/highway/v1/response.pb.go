...
type AccessNameResponse struct {
	...
	Peer *types.Peer `protobuf:"bytes,3,opt,name=peer,proto3" json:"peer,omitempty"`
}
...
func (x *AccessNameResponse) GetPeer() *types.Peer {
	if x != nil {
		return x.Peer
	}
	return nil
...
type ListenBucketResponse struct {
	...
	Objects []*types1.ObjectDoc `protobuf:"bytes,4,rep,name=objects,proto3" json:"objects,omitempty"` // optional
}
...
func (x *ListenBucketResponse) GetObjects() []*types1.ObjectDoc {
	if x != nil {
		return x.Objects
	}
	return nil
...
var file_v1_response_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x64, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x24, 0x5a, 0x22, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6e, 0x72, 0x2d, 0x69,
	0x6f, 0x2f, 0x73, 0x6f, 0x6e, 0x72, 0x2f, 0x68, 0x69, 0x67, 0x68, 0x77, 0x61, 0x79, 0x2f, 0x76,
...
var file_v1_response_proto_goTypes = []interface{}{
	...
	(*types.Peer)(nil),            // 11: sonrio.sonr.registry.Peer
	(*types.Did)(nil),             // 12: sonrio.sonr.registry.Did
	(*types1.ObjectDoc)(nil),      // 13: sonrio.sonr.object.ObjectDoc
	(*types.DidDocument)(nil),     // 14: sonrio.sonr.registry.DidDocument
}
