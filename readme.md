# sonr
**sonr** is a blockchain built using Cosmos SDK and Tendermint and created with [Starport](https://starport.com).
...
```
curl https://get.starport.com/sonr-io/sonr@latest! | sudo bash
```
